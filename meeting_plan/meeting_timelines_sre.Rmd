...
| Leader Name: Jacob Green | Course: Timeline and SRE's     |
|--------------------------|--------------------------------|
| Date created:            | Date implemented: 2/14/2020|
...
1. List the most important concepts and skill introduced in this topic
    ...
    b. Skills
      * Using a spreadsheet to organize your choices
      * Organization around the priority tasks that need to be completed to reach your end goal
      * Build a timeline that can help you reach monthly and quarterly goals
